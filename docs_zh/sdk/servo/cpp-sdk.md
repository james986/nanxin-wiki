...
{{ github_download_table("", "v1.2026.0214", "https://github.com/servodevelop/servo-uart-rs485-sdk", "./data/cpp-sdk.zip", "28px") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/u45-slide-01.png","u45-slide-01.png", "100%", "3.5em") }}

总线伺服舵机转接板UC-01

{{ fig_indent_adjustable("../images/cpp-sdk/1.4.png","1.4.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730140643317.png","image-20240730140643317", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730140655400.png","image-20240730140655400", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730140728786.png","image-20240730140728786", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730141009167.png","image-20240730141009167", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730141023372.png","image-20240730141023372", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730141031044.png","image-20240730141031044", "100%", "3.5em") }}

## 5. 如何运行示例代码

在 `fashionstar-uart-servo-cpp-sdk/example` 文件夹下，存放了若干独立的示例工程，每个例程都是独立的。

{{ fig_indent_adjustable("../images/cpp-sdk/image-20250110174541989.png","image-20250110174541989", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730142136424.png","image-20240730142136424", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730151601922.png","image-20240730151601922", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730152136903.png","image-20240730152136903", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730153459753.png","image-20240730153459753", "100%", "3.5em") }}
**函数原型**
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730170857129.png","image-20240730170857129", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730170921388.png","image-20240730170921388", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/image-20240730171434178.png","image-20240730171434178", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/cpp-sdk/ADC.png","ADC.png", "100%", "3.5em") }}
