...
{{ pdf_line("../pdf/Fashion-Star-HP8-RP8-U45H-M.pdf", "下载规格书", "48px") }}
...
<table>
  ...
  <tr>
    <td>静态堵转扭矩</td>
    <td>4.41 N·m（45kg·cm）</td>
  </tr>
  <tr>
    <td>最大动态扭矩</td>
    <td>1.67 N·m（17kg·cm）</td>
  </tr>
  <tr>
    <td>额定扭矩</td>
...
{{ fig_center("../images/U45H-torque-speed-curve.png", "T-N 特性曲线", "500px") }}

{{ fig_center("../images/U45H-mechanical-overload-curve.png", "机械过载曲线", "500px") }}
