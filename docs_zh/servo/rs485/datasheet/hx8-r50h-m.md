...
{{ pdf_line("../pdf/Fashion-Star-HX8-R50H-M.pdf", "下载规格书", "48px") }}
...
{{ fig_center("../images/R50-torque-speed-curve.png", "T-N 特性曲线", "500px") }}

{{ fig_center("../images/R50-mechanical-overload-curve.png", "机械过载曲线", "500px") }}
