...
<table>
  ...
  <tr>
    <td>静态堵转扭矩</td>
    <td>3.43 N·m（35kg·cm）</td>
  </tr>
  <tr>
    <td>最大动态扭矩</td>
    <td>1.27 N·m（13kg·cm）</td>
  </tr>
  <tr>
    <td>额定扭矩</td>
    <td>0.54 N·m（5.5kg·cm）</td>
  </tr>
  <tr>
    <td>空载转速</td>
    <td>34 rpm（0.298 s / 60°）</td>
  </tr>
  <tr>
    <td>额定转速</td>
    <td>16 rpm（0.625 s / 60°）</td>
  </tr>
  <tr>
    <td>峰值电流</td>
    <td>3 A</td>
...
{{ fig_center("../images/U35-torque-speed-curve.webp", "T-N 特性曲线", "500px") }}

{{ fig_center("../images/U35-mechanical-overload-curve.webp", "机械过载曲线", "500px") }}





<!-- ##4.外观尺寸与安装（没有include，按照模版填入） -->
## 4. 外观尺寸与安装
