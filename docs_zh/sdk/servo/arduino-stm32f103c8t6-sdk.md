# 总线伺服舵机 SDK 使用手册（Arduino STM32F103C8T6）
...
{{ fig_indent_adjustable("../images/arduino-sdk/image14.png","image14", "100%", "3.5em") }}

工具→开发板→开发板管理器，搜索"`STM32`"

找到对应第三方核心库，安装

{{ fig_indent_adjustable("../images/arduino-sdk/image15.png","image15", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/arduino-sdk/image16.png","image16", "100%", "3.5em") }}

### 2.5 演示例程的操作流程

**·** 将`STM32F103C8T6`板子使用`ST-LINK`与`PC`相连

{{ fig_indent_adjustable("../images/arduino-sdk/image17.png","image17", "100%", "3.5em") }}
