...
{{ pdf_line("../pdf/Fashion-Star-RX18-R101W-M.pdf", "下载规格书", "48px") }}


<!-- 产品主图，中文taobao/英文simple -->
{% include-markdown "../../../snippets/shop-info/product-primary-taobao.md"
  start="<!--start:RX18-R101W-M-->"
      end="<!--end:RX18-R101W-M-->" %}
...
{{ fig_center("../images/R101W-torque-speed-curve.png", "T-N 特性曲线", "500px") }}

{{ fig_center("../images/R101W-mechanical-overload-curve.png", "机械过载曲线", "500px") }}
