...
{{ github_download_table("", "v1.2026.0214", "https://github.com/servodevelop/servo-uart-rs485-sdk", "./data/python-sdk.zip", "28px") }}
...
### 2.2 总线伺服舵机调试软件
- 请参考《[总线伺服舵机调试软件](../../software/servo/pc-config-software.md)》提前分配 ID 或修改配置参数。
