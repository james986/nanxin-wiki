...
{{ pdf_line("../pdf/Fashion-Star-HP8-A46.pdf", "下载规格书", "48px") }}
...
{% include-markdown "../../../snippets/datasheet/datasheet-snippets.md"
  start="<!--start:spec-01-pwm-coreless-->"
      end="<!--end:spec-01-pwm-coreless-->" %}
...
<table>
  ...
  <tr><td>空载速度</td><td>@8.4V: 0.085 sec / 60°<br>@7.4V: 0.098 sec / 60°<br>@6.0V: 0.118 sec / 60°</td></tr>
