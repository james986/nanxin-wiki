# 总线伺服舵机 SDK 使用手册（STM32F407）

<!--一以下是SDK页面用的表格宏（适用协议/版本/GitHub链接/单个下载文件-->
{{ github_download_table("", "v1.2026.0214", "https://github.com/servodevelop/servo-uart-rs485-sdk", "./data/stm32f407-sdk.zip", "28px") }}

## 1. 概述

本 SDK 基于 Fashion Star 总线伺服舵机的 [UART/RS485 通信协议](../../servo/uart/protocols/uart-rs485-protocol.md) 开发，提供 Python API，适用于全系列舵机型号。
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/u45-slide-01.png","u45-slide-01.png", "100%", "3.5em") }}



总线伺服舵机转接板UC-01

{{ fig_indent_adjustable("../images/stm32f407-sdk/1.4.png","1.4.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/5FqhToADH8mYEOK.jpg","5FqhToADH8mYEOK.jpg", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/1g9HwAQkvd7bzco.jpg","1g9HwAQkvd7bzco.jpg", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/uhp2FtvE37R5KNL.png","uhp2FtvE37R5KNL.png", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/stm32f407-sdk/tNQ1VXp3SeaFOAK.png","tNQ1VXp3SeaFOAK.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/UfH2xbBg3LNevsZ.png","UfH2xbBg3LNevsZ.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/uvrpsjYzU32J7qS.png","uvrpsjYzU32J7qS.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/8QpS4N7KRVYGy25.png","8QpS4N7KRVYGy25.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/aUC5oRVfSQlPuGd.png","aUC5oRVfSQlPuGd.png", "100%", "3.5em") }}

勾选`Reset and Run`选项，方便测试。

{{ fig_indent_adjustable("../images/stm32f407-sdk/etGhiwqoLDS7cpY.png","etGhiwqoLDS7cpY.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/Jdp6xU7a1ZsnLv2.png","Jdp6xU7a1ZsnLv2.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/3.1.png","3.1.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/5_1.png","5_1.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/5_2.png","5_2.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/5_3.png","5_3.png", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/6_1.png","6_1", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/6_2.png","6_2", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/6_3.png","6_3", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/stm32f407-sdk/ADC.png","ADC.png", "100%", "3.5em") }}
