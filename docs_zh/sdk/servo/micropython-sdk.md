# 总线伺服舵机 SDK 使用手册（MicroPython / ESP32）

<!--一以下是SDK页面用的表格宏（适用协议/版本/GitHub链接/单个下载文件-->
{{ github_download_table("", "v1.2026.0214", "https://github.com/servodevelop/servo-uart-rs485-sdk", "./data/micropython-sdk.zip", "28px") }}
...
{{ fig_indent_adjustable("https://wiki.fashionrobo.com/uart-micropython-esp32-sdk/images/UeFt7gqjcRJAl4O.png","image-20210623145003177", "100%", "3.5em") }}
...
[MicroPython-ESP32开发环境配置(Win10+Thonny IDE)](https://blog.csdn.net/Little_Carter/article/details/128597071)

请下载以下版本的固件进行烧录

- [v1.27.0 (2025-12-09) .bin](https://micropython.org/resources/firmware/ESP32_GENERIC-20251209-v1.27.0.bin)
- 如需旧版本（与本文原版本一致）：[v1.16 (2021-06-23) .bin](https://micropython.org/resources/firmware/ESP32_GENERIC-20210623-v1.16.bin)
- 固件下载页：[MicroPython ESP32_GENERIC 下载页](https://micropython.org/download/ESP32_GENERIC/)
...
{{ fig_indent_adjustable("https://wiki.fashionrobo.com/uart-micropython-esp32-sdk/images/LZlzbdSorqkJ53s.png","image-20210604163918319", "100%", "3.5em") }}

运行例程代码的方式也比较简单，`example/`文件夹下的`.py`文件拷贝到Thonny IDE代码编辑区，保存为`main.py`到ESP32文件系统即可。

{{ fig_indent_adjustable("https://wiki.fashionrobo.com/uart-micropython-esp32-sdk/images/u3xtTFoqnSNBKkz.png","image-20210604164117545", "100%", "3.5em") }}
...
异步执行指令，立即执行缓存指令。若参数 cancel 为1，则清除缓存。
