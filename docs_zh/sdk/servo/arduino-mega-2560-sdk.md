# 总线伺服舵机 SDK 使用手册（Arduino Mega2560）
...
{{ fig_indent_adjustable("../images/arduino-sdk/image09.png","image09", "100%", "3.5em") }}

**·** 接线 - `Arduino Mega2560`与`PC`通过`USB`线相连接

**·** 在`PC`端打开`Arduino IDE`，打开`FashionStar`总线伺服舵机的例程文件：

[打开Arduino示例代码-流程演示](../images/arduino-sdk/打开Arduino示例代码-流程演示.mp4)

{{ fig_indent_adjustable("../images/arduino-sdk/image05.png","image05", "100%", "3.5em") }}

**·** 选择开发板型号为`Arduino Mega2560`，选择端口号

{{ fig_indent_adjustable("../images/arduino-sdk/image10.png","image10", "100%", "3.5em") }}

**·** 给串口舵机转接板供电，电压7.2V

**·** 编译并烧录固件

{{ fig_indent_adjustable("../images/arduino-sdk/image11.png","image11", "100%", "3.5em") }}

**·** 查看日志输出（波特率选择115200）

{{ fig_indent_adjustable("../images/arduino-sdk/image07.png","image07", "100%", "3.5em") }}

{{ fig_indent_adjustable("../images/arduino-sdk/image08.png","image08", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/arduino-sdk/image12.jpg","image12", "100%", "3.5em") }}
...
{{ fig_indent_adjustable("../images/arduino-sdk/image13.png","image13", "100%", "3.5em") }}
