...
<table>
  ...
  <tr>
    <td>静态堵转扭矩</td>
    <td>3.92 N·m（40kg·cm）</td>
  </tr>
  <tr>
    <td>最大动态扭矩</td>
    <td>1.50 N·m（15.3kg·cm）</td>
  </tr>
  <tr>
    <td>额定扭矩</td>
    <td>0.49 N·m（4.95kg·cm）</td>
  </tr>
  <tr>
    <td>空载转速</td>
...
{{ fig_center("../images/U45H-brushless-torque-speed-curve.webp", "T-N 特性曲线", "500px") }}

{{ fig_center("../images/U45H-brushless-mechanical-overload-curve.webp", "机械过载曲线", "500px") }}
